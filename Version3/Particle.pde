class particle { 
  ...
  particle (int _type, color _c) {  
    ...
    loc = new PVector (random(0, width) + noise(10), random(2*height/3, 6*height/7));  
    loc2 = new PVector (random(-50, width), random(6*height/10, 9*height/10)); 
    loc3 = new PVector (random(-20, width), random(2*height/3, height)); 
    loc4 = new PVector (random(0, width), random(height/2, height));
    loc5 = new PVector (random(0, width), random(2*height/5, 4*height/5)); 
    loc6 = new PVector (random(0, width), random(7*height/9, height)); 
    loc7 = new PVector (random(0, width), random(4*height/5, height)); 
